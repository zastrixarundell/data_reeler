defmodule DataReeler.StoresTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{description: nil, title: nil, url: nil, provider: nil, isbn: nil, price: nil, images: nil, categories: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      valid_attrs = %{description: ["option1", "option2"], title: "some title", url: "some url", provider: "some provider", isbn: "some isbn", price: [], images: ["option1", "option2"], categories: ["option1", "option2"]}
    ...
    test "update_product/2 with valid data updates the product" do
      product = product_fixture()
      update_attrs = %{description: ["option1"], title: "some updated title", url: "some updated url", provider: "some updated provider", isbn: "some updated isbn", price: [], images: ["option1"], categories: ["option1"]}
      ...
      assert product.isbn == "some updated isbn"
      assert product.price == []
